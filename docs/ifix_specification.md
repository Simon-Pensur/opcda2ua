...
Donde:
- **NODO**: Nombre del nodo SCADA (ej: `UYMVDA01`)
- **TAG**: Nombre del bloque/tag en iFIX (ej: `AACOMSTATPLC1`)
...
```
UYMVDA01.AACOMSTATPLC1.F_CV    <- Rama AA, valor float
UYMVDA01.AI_TEMP_001.F_CV      <- Rama AI, valor float
UYMVDA01.TX_MESSAGE_01.A_CV    <- Rama TX, valor texto
UYMVDA01.DI_PUMP_RUN.F_CV      <- Rama DI, valor float (0/1)
```
